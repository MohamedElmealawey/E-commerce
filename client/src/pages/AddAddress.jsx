                    ...
                    <form onSubmit={onSubmitHandler} className='space-y-3 mt-6 text-sm'>
                        <div className='grid grid-cols-2 gap-4'>
                            <input
                                ...
                                text-gray-500 focus:border-primary-dull transition'
                        ...
                        <div className='grid grid-cols-2 gap-4'>
                            <input
                                ...
                                address={address}
                                name="zipcode" 
                                type="number"  // Changed from "number" to "text" to handle zip codes with letters
                        ...
                        <button 
                            type="submit"
                            className='w-full mt-6 bg-primary-dull text-white
                            py-3 hover:bg-primary-dull transition cursor-pointer uppercase

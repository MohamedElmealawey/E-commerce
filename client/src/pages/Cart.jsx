...
const Cart = () => {
    const {products, currency, cartItems, removeCartItem, getCartCount,
        updateCartItem, navigate,setCartItems, getCartAmount,axios,user} = useContext(AppContext);
    ...
    return products.length > 0 && cartItems ? (
        <div className="flex flex-col md:flex-row mt-16">
            <div className='flex-1 max-w-4xl'>
                ...
                <button onClick={() => navigate("/products")} className="group cursor-pointer flex items-center mt-8 gap-2 text-primary-dull font-medium">
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        ...
                        {showAddress && (
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                                ...
                                <p onClick={() => navigate("/add-address")} className="text-primary-dull text-center cursor-pointer p-2 hover:bg-primary-dtext-primary-dull/10">
                                    Add address
                                </p>
                            </div>
                        )}
                ...
                <button onClick={placeOrder} className="w-full py-3 mt-6 cursor-pointer bg-primary-dull text-primary-dull text-white font-medium hover:bg-primary-dull transition">

        ...
        <div onClick={()=>{
            ...
            <div className="text-gray-500/60 text-sm">
                ...
                <div className="flex items-end justify-between mt-3">
                    ...
                    <div onClick={(e)=>{e.stopPropagation();}} className=" cursor-pointer text-primary-500">
                        {!cartItems[product?._id] ? (
                            <button className="cursor-pointer flex items-center justify-center gap-1 bg-primary-100 border border-primary-300 md:w-[80px] w-[64px] h-[34px] rounded text-primary-600 font-medium" 
